...
// Fix capitalization in name without function
...
// Fix capitalization in name with function
...
console.log(maskCreditCard(3675903157692201));
console.log(maskCreditCard(5829103850282946));
console.log(maskCreditCard('6920184959201035'));

// Repeat
const badMessage = 'Bad weather... All Departures Delayed... ';
console.log(badMessage.repeat(5));
